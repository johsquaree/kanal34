...
export default function AdvancedSearch({ onSearch, categories }: AdvancedSearchProps) {
  ...
  const handleFilterChange = (key: keyof SearchFilters, value: string) => {
    const newFilters = { ...filters, [key]: key === 'sortOrder' ? (value as 'asc' | 'desc') : value };
    setFilters(newFilters as SearchFilters);
    onSearch(newFilters as SearchFilters);
  };

  const handleSortOrderChange = () => {
    const newOrder = filters.sortOrder === 'asc' ? 'desc' : 'asc';
    const newFilters = { ...filters, sortOrder: newOrder };
    setFilters(newFilters as SearchFilters);
    onSearch(newFilters as SearchFilters);
  };
  ...
  const clearFilters = () => {
    ...
    setFilters(defaultFilters as SearchFilters);
    onSearch(defaultFilters as SearchFilters);
  };
